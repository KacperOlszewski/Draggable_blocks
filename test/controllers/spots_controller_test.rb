...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { name: @spot.name, position_x: @spot.position_x, position_y: @spot.position_y }
    end
  ...
  test "should update spot" do
    patch :update, id: @spot, spot: { name: @spot.name, position_x: @spot.position_x, position_y: @spot.position_y }
    assert_redirected_to spot_path(assigns(:spot))
  end
